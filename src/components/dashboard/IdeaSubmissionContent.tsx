...
export default function IdeaSubmissionContent() {
  ...
  if (showSuccess) {
    return (
      <TooltipProvider>
        <div className="max-w-7xl mx-auto px-3 sm:px-4 py-8 flex items-center justify-center">
            ...
            <Card className="bg-slate-900/70 backdrop-blur-lg border border-slate-700/60 shadow-xl">
              <CardHeader>
                ...
                <CardDescription className="text-slate-300 leading-relaxed">
                  ...
                  invested on Polygon. Mint your idea to earn 1 $FRYE with a unique
